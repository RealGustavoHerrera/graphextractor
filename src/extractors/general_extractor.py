...
class GeneralExtractor(LangExtractor):
        ...
        self.examples = [
            lx.data.ExampleData(
                    ...
                    extractions=[
                        ...
                        lx.data.Extraction(extraction_class="symptom", extraction_text="Her first episode of the affective disorder was that of mania at the age of eleven", 
                                        attributes={"diagnosis":"mania", "duration": "past six years", "since" : "11 years old", "related_condition":"bipolar affective disorder"}),
                        lx.data.Extraction(extraction_class="symptom", extraction_text="for her depressive features", 
                                        attributes={"diagnosis":"depression", "duration": "past six years", "since" : "11 years old", "related_condition":"bipolar affective disorder"}),
                        lx.data.Extraction(extraction_class="symptom", extraction_text="sustained and abnormal contraction of the neck muscles", 
                        ...
                        lx.data.Extraction(extraction_class="symptom", extraction_text="discomfort in the neck and lower back as well as restriction of body movements", 
                        ...
                        lx.data.Extraction(extraction_class="symptom", extraction_text="not able to maintain an erect posture and would tend to fall on either side while standing up from a sitting position", 
                                        attributes={"diagnosis":"unspecified", "duration": "past four months", "since" : "when she was introduced to olanzapine tablets", "related_condition" : "tardive dystonia"}),
                        lx.data.Extraction(extraction_class="symptom", extraction_text="keep her head turned to the right and upwards due to the sustained contraction of the neck muscles", 
                                        attributes={"diagnosis":"unspecified", "duration": "past four months", "since" : "when she was introduced to olanzapine tablets", "related_condition" : "tardive dystonia"}),
                        lx.data.Extraction(extraction_class="symptom", extraction_text="sideways bending of the back in the lumbar region", 
                                        attributes={"diagnosis":"unspecified", "duration": "past four months", "since" : "when she was introduced to olanzapine tablets", "related_condition" : "tardive dystonia"}),

                        lx.data.Extraction(extraction_class="condition", extraction_text="bipolar affective disorder", attributes={"cause":"unspecified", "age" : "11 years old"}),
                        lx.data.Extraction(extraction_class="condition", extraction_text="rigidity in her upper limbs", attributes={"cause":"unspecified", "age" : "11 years old"}),
                        lx.data.Extraction(extraction_class="condition", extraction_text="amenorrhea", attributes={ "age": "14 years old", "cause" : "sodium valproate", "concurrent medications" :[ "sodium valproate", "escitalopram"], "prescribed_medication":["discontinue sodium valproate", "lithium"]}),
                        lx.data.Extraction(extraction_class="condition", extraction_text="hypothyroidism", attributes={"age":"14 years old","cause":"unspecified", "concurrent_medications":["lithium", "escitalopram"], "prescribed_medication":"eltroxin"}),
                        lx.data.Extraction(extraction_class="condition", extraction_text="tardive dystonia", attributes={"cause":"olanzapine", "age":"16 years old"}),
