    ...
    def __init__(self, model):
        ...
        self.examples = [
            lx.data.ExampleData(
                    ...
                    extractions=[
                        lx.data.Extraction(extraction_class="demographics", extraction_text="16 years old", attributes={"years":"16"}),
                        lx.data.Extraction(extraction_class="demographics", extraction_text="girl", attributes={"sex": "female"}),

                        lx.data.Extraction(extraction_class="condition", extraction_text="bipolar affective disorder", attributes={ "age" : "11 years old"}),
                        lx.data.Extraction(extraction_class="condition", extraction_text="amenorrhea", attributes={ "age": "14 years old", "cause" : "sodium valproate" }),
                        lx.data.Extraction(extraction_class="condition", extraction_text="hypothyroidism", attributes={"age":"14 years old" }),
                        lx.data.Extraction(extraction_class="condition", extraction_text="dystonia", attributes={"age":"16 years old", "cause":"olanzapine"}),

                        lx.data.Extraction(extraction_class='relationship', extraction_text="introduced to olanzapine tablets for the control of her exacerbated mental illness", 
                                           attributes={ "entity_1" : "olanzapine", "entity_2" : "bipolar affective disorder"}),
                        lx.data.Extraction(extraction_class='relationship', extraction_text="she was given tablet trihexyphenidyl 4 mg per day for rigidity in her upper limbs", 
                                           attributes={ "entity_1" : "trihexyphenidyl", "entity_2" : "dystonia"}),
                        lx.data.Extraction(extraction_class='relationship', extraction_text="She was put on tablet sodium valproate, 1000 mg per day during this period for the stabilization of her mood", 
                                           attributes={ "entity_1" : "sodium valproate", "entity_2" : "bipolar affective disorder"}),
                        lx.data.Extraction(extraction_class='relationship', extraction_text="she was also given escitalopram for a period of three months for her depressive features", 
                                           attributes={ "entity_1" : "escitalopram", "entity_2" : "bipolar affective disorder"}),
                        lx.data.Extraction(extraction_class='relationship', extraction_text="Keeping in mind the possibility of valproate-induced menstrual disturbance, she was shifted to tablet lithium 450 mg per day", 
                                           attributes={ "entity_1" : "lithium", "entity_2" : "bipolar affective disorder"}),
                        lx.data.Extraction(extraction_class='relationship', extraction_text="she developed hypothyroidism for which eltroxin was introduced", 
                                           attributes={ "entity_1" : "eltroxin", "entity_2" : "hypothyroidism"}),
                        lx.data.Extraction(extraction_class='relationship', extraction_text="exacerbation of the mood symptoms in the form of mania warranted a need for the introduction of olanzapine (by a different treatment team)", 
                                           attributes={ "entity_1" : "olanzapine", "entity_2" : "bipolar affective disorder"}),
                        lx.data.Extraction(extraction_class='relationship', extraction_text="she was put on tablet tetrabenazine (built up to 75 mg per day in divided doses) with which the patient had started showing some response with an improvement in abnormal movements of the muscles of the neck as well as the back", 
                                           attributes={ "entity_1" : "tetrabenazine", "entity_2" : "dystonia"}),

                        lx.data.Extraction(extraction_class="medication", extraction_text="olanzapine", 
                                        attributes = {"dosis":"2.5 mg per dose", "frequency":"per day", "condition":"bipolar affective disorder"}),
                        lx.data.Extraction(extraction_class="medication", extraction_text="trihexyphenidyl", 
                                        attributes = {"dosis":"4mg", "frequency":"per day", "duration" : "three weeks", "condition":"dystonia"}),
                        lx.data.Extraction(extraction_class="medication", extraction_text="sodium valproate", 
                                        attributes = {"dosis":", 1000 mg", "frequency":"per day","duration": "three months", "condition":"bipolar affective disorder"}),
                        lx.data.Extraction(extraction_class="medication", extraction_text="escitalopram", 
                                        attributes = {"duration" : "three months", "condition":"bipolar affective disorder"}),
                        lx.data.Extraction(extraction_class="medication", extraction_text="lithium", 
                                        attributes={"dosis" : "450 mg per day", "duration": "two years", "condition":"bipolar affective disorder"}),
                        lx.data.Extraction(extraction_class="medication", extraction_text="eltroxin", 
                                        attributes={"dosis": "50 micrograms per day", "condition":"hypothyroidism"}),
                        lx.data.Extraction(extraction_class="medication", extraction_text="olanzapine", 
                                        attributes={ "dosis":"10mg", "frequency":"per day", "condition":"bipolar affective disorder"}),
                        lx.data.Extraction(extraction_class="medication", extraction_text="tetrabenazine", 
                                        attributes = { "dosis":"75 mg", "frequency":"per day divided in doses", "condition":"dystonia"}),
                    ],
                ),
            ]